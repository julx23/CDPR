...
updateB = [error1D(1:end-1)*gain1D zeros(1, numel(Av_old)-numel(error1D))] + [errorZ*gainZ zeros(1, numel(Bv_old)-numel(errorZ))] + errorEnB*gainEn;
...
legend("Motor 1 new", "Motor 2 new", "Motor 1 old", "Motor 2 old", "Encoder 1 error adjustment", "Encoder 2 error adjustment","mocap 1D error adjustment");
