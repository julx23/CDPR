...
/* ENCODER_A and ENCODER_B pins are used to read the encoder
   ...
   pins
*/
// for the teensy 2.0, 5, 6, 7, 8 are interrupt pins
#define ENCODER_A 7
#define ENCODER_B 8
#define ENCODER_A2 5 
#define ENCODER_B2 6
#define loadCellPin1 A5
...
void loop() {
  while (Serial.available() > 0) {
    ...
    if (incomingByte != 'g') {
      ...
      runTraj(motor_1_commands, motor_2_commands, motor_2_commands_index);
...
void runTraj(int motor_1_commands[], int timings[], int length) {
